...
const PatientInfoBar = ({ patient }: PatientInfoBarProps) => {
  return (
    <div className="w-full flex justify-evenly rounded-2xl border-2 border-blue-500 items-center text-2xl h-[80px] bg-neutral-300 dark:text-white dark:bg-slate-800">
      <div className="flex">
